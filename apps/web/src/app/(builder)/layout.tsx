    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#0A0A0F' }}>
      ...
      >
        <div className="px-6 py-6 border-b border-white/8">
          ...
          <span className="ml-8 text-xs px-2 py-0.5 rounded bg-purple-500/20 text-purple-400 border border-purple-500/20">
            Builder Portal
          </span>
        </div>
        ...
        <div className="p-4 border-t border-white/8">
          <div className="flex items-center gap-3 px-3 py-3 rounded-xl bg-white/5">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">Prestige Group</p>
              <p className="text-xs text-green-400 truncate">✅ RERA Verified</p>
            </div>
          </div>
        </div>
      </aside>
